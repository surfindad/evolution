...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#A8A8B0]">
      ...
      {/* Vignette */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#A8A8B0]/30 via-transparent to-[#A8A8B0]/50 pointer-events-none" />
