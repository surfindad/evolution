...
export default function MarqueeStrip() {
  ...
  return (
    <section className="py-28 bg-[#DFC9A0] overflow-hidden">
      ...
      <div className="marquee-container relative mb-4">
        <div className="absolute left-0 top-0 bottom-0 w-40 bg-gradient-to-r from-[#DFC9A0] to-transparent z-10 pointer-events-none" />
        <div className="absolute right-0 top-0 bottom-0 w-40 bg-gradient-to-l from-[#DFC9A0] to-transparent z-10 pointer-events-none" />
